...
Invert log ratio transformation on prior for $\mu_T$ to get the implied prior on $\pi_T$
```{r}
...
```{r}
plts[[scen]][["plt_probwin_election"]] <- plot_prob_win_electoral_college(
...
```{r}
plts[[scen]][["plt_probwin_states"]] <- plot_prob_win_states(
...
#### Calculate mean expected vote share 
...
#| echo: false
#| warning: false
plts[["A"]][["plt_probwin_election"]]
```

```{r}
#| echo: false
#| warning: false
plts[["A"]][["plt_probwin_states"]]
```
