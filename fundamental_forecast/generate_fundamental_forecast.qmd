...
where $y^s_{e}$ is a vector of the parties' vote shares in state $s$ in election $e$. $x^{*}_e$ denote the latest two values of a macroeconmic variable before election $e$, e.g. for the election in 2023 y/y GDP growth in 2023Q1 and 2022Q4 and $z_e$ a dummy variable controlling for the incumbent party. 
