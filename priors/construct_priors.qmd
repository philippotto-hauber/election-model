...
- regularization of $\boldsymbol{\hat{W}}$
- simulate trajectories of $\mu_{1:T}$ for different values of $\kappa$ given $\boldsymbol{\hat{W}}$
- simulate house effects by drawing from -> use a sequence of polls from previous election as starting point
