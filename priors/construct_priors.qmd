...
To evaluate if the joint prior distribution specified above translates into reasonable prior beliefs for the expected voting intentions or observed polls, I construct samples from the *prior predictive distribution* in the different scenarios.
